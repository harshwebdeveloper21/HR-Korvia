        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h4 class="card-title mb-0">Add Experience Letter Template</h4>
                ...
                <form id="exprinceTemplateForm" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="title" id="title" placeholder="Enter template title (e.g. Standard Experience Letter)" required />
                            </div>
                    ...
                    <div class="text-end mt-4">
                        ...
                        <button type="submit" class="btn hr-btnbg interviewsmbtn" id="submitBtn">
                            <i class="mdi mdi-check me-1"></i> Save Template
                        </button>
                    </div>
                </form>
...
<script>
    const defaultTemplateContent = `<p><strong>TO WHOM IT MAY CONCERN,</strong></p>

<p>This is to certify that <strong>{{salutation}} {{employee_name}}</strong> was working at <strong>{{company_name}}</strong> as <strong>{{designation}}</strong> from <strong>{{from_date}} to {{to_date}}</strong>.</p>

<p>During this period, {{his_her}} services were found to be satisfactory in carrying out the job duties.</p>

<p>We wish {{him_her}} all the best for {{his_her}} career ahead.</p>

<p>&nbsp;</p>
<p>&nbsp;</p>

<p><strong>Raj Singh,</strong><br />
<strong>Co-Founder / CTO / CEO</strong><br />
<strong>{{company_name}}</strong></p>`;
    ...
    $(document).ready(function () {
        ...
        CKEDITOR.replace('content', {
            ...
            on: {
                instanceReady: function (evt) {
                    ...
                    evt.editor.setData(defaultTemplateContent);
                }
            }
        });
        ...
        $('#exprinceTemplateForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?= site_url("api/exprience-templates/save-data") ?>',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
                ...
                error: function (xhr) {
                    ...
                    if (xhr.status === 422 && xhr.responseJSON && xhr.responseJSON.errors) {
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Error',
                            text: xhr.responseJSON?.message || 'Failed to save template.'
                        });
                    }
                }
            });
