        ...
        <div class="col-md-8 grid-margin stretch-card mx-auto">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-description">Enter details for the company expense or reimbursement.</p>
                    ...
                    <form action="<?= base_url('expenses/store') ?>" method="POST" enctype="multipart/form-data" class="forms-sample">
                        <?= csrf_field() ?>
                        ...
                        <div class="text-end">
                            ...
                            <button type="submit" class="btn hr-btnbg me-2">Save Expense</button>
                        </div>
                    </form>
                </div>
            </div>
