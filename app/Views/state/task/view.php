    ...
    <div class="modal-dialog modal-lg d-flex justify-content-center align-items-center"> <!-- Centered Modal -->
        <div class="modal-content rounded-3">
            ...
            <div class="modal-footer"> <!-- Center footer buttons -->
                <button type="button" class="btn hr-btnbg rounded-pill" data-bs-dismiss="modal">Cancel</button>
                    ...
                    <table class="table table-striped" id="task-table">
                        <thead>
                            <tr>
                                ...
                                <th>Due Date</th>
                                <th>Status</th>
                                <th style="display: none;">Created At</th> <!-- hidden sorting column -->
                                <th>Action</th>
                            </tr>
                        </thead>
    ...
    $(document).ready(function() {
        ...
        function fetchTasks(statusFilter = '') {
            ...
            <span class="capitalize-text">${task.username}</span>
                            ...
                            <td class="capitalize-text">${task.assigned_date}</td>
                            <td class="capitalize-text">${task.due_date}</td>
                            <td class="py-1">${statusDisplay}</td>
                                    <td style="display: none;">${task.created_at}</td>
                            <td style="display: flex; align-items: center; gap: 8px; padding-bottom: 38px;">
                                ${actionButtons}
                            </td>
                        </tr>
                    `;
