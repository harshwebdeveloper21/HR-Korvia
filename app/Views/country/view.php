            ...
            <div class="card-body">
                <div class="d-md-flex justify-content-between align-items-center mb-3">
                    ...
                    <div class="d-flex gap-2">
                        <button type="button" id="btnExportCountry" class="btn hr-btnbg attendenceall text-nowrap">
                            <i class="mdi mdi-file-excel iconfontsize"></i> Export Excel
                        </button>
                        <a href="/country" class="btn hr-btnbg attendenceall text-nowrap">
...
<script>
            ...
            success: function(responseData) {
                if (responseData.status === 'success') {
                    ...
                    countries.forEach((country, index) => {
                        const formattedName = country.country_name.charAt(0).toUpperCase() + country.country_name.slice(1).toLowerCase();
                        ...
                        row.html(`
                            ...
                            <td>
                                <div style="flex: 1;">
                                    ...
                                    <div class="expanded-details" id="country-details-${country.id}" onclick="event.stopPropagation();">
                                        <div class="detail-actions">
                                            <a href="/country?id=${country.id}" class="btn btn-sm btn-warning"><i class="mdi mdi-pencil"></i> Edit</a>
                            ...
                            <td class="desktop-only-col" style="display: flex; align-items: center; gap: 8px;">
                                <a href="/country?id=${country.id}" class="text-warning fs-5" title="Edit"><i class="mdi mdi-pencil"></i></a>
                            ...
                            <td class="mobile-expand-col text-center">
                                <button type="button" class="expand-toggle" data-target="country-details-${country.id}" aria-label="Expand details"></button>
                            </td>
                        `);
    ...
    function deleteCountry(event) {
        ...
        $('#btnExportCountry').on('click', function () {
            const $btn = $(this);
            ...
            fetch(`<?= base_url('api/country/export') ?>?${queryParams.toString()}`, {
                method: 'GET',
            ...
            .then(blob => {
                ...
                a.download = `Countries_${dateStr}.xlsx`;
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'Exported!',
                    text: 'Countries exported to Excel successfully.',
                    toast: true,
                    position: 'top-end',
                    timer: 3000,
            ...
            .catch(error => {
                $btn.prop('disabled', false).html('<i class="mdi mdi-file-excel iconfontsize"></i> Export Excel');
                Swal.fire('Export Error', error.message || 'Failed to export countries', 'error');
            });
        });
    });
</script>
